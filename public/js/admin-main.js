window.addEventListener('DOMContentLoaded', async function () {
  ...
  await getAllCategory()
    .then((response) => {
      ...
      main.forEach((e) => {
        const mainOp = document.createElement('option')// create option
  ...
  await getRegion()
    .then((result) => {
      ...
      regionData.forEach((e) => {
        const regionOp = document.createElement('option')// create option
        regionOp.setAttribute('value', e.id)// value
        const t = document.createTextNode(e.region_name)// name
